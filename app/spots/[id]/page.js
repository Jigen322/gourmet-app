...
export default async function SpotDetailPage({ params }) {
  ...
  return (
    <div className="container" style={{ maxWidth: 680, paddingTop: 40, paddingBottom: 60 }}>
      ...
      <h1 style={{ fontSize: '1.8rem', marginTop: 24 }}>{spot.title}</h1>
      ...
      {spot.category && <span className="role-badge role-poster" style={{ marginTop: 12, display: 'inline-block' }}>{spot.category}</span>}
